            ...
            <div className="row">
                <div className="col-12 col-md-6 mx-auto">
                    <form className='flex flex-column gap-4 border-4 p-3' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input className='border-2 pl-2' type="text" {...register("supplier")} value={user?.displayName} required placeholder='Supplier' />
                        <input className='border-2 pl-2' type="email"  {...register("email")} value={user?.email} required placeholder='Email' />
